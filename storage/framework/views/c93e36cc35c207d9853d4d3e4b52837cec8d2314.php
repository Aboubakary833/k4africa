...
<?php $component = $__env->getContainer()->make(App\View\Components\Breadcrumb::class, ['title' => 'Demande de dévis','currentPage' => 'Demander un dévis']); ?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-10 offset-xl-1 col-12">
                            <form id="contact-form" action="<?php echo e(route('askdevis')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="row">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Yaya\Desktop\k4arefonte\resources\views/pages/devis.blade.php ENDPATH**/ ?>